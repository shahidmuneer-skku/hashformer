...
def main(args):
    ...
    # Create the dataset
    path = args.base_dir
    full_train = HashFormerDataset(path, partition="train", take_datasets="KoDF,1")
   ...
   # ----------------  optimiser  ----------------
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        # {"loader":faceswap_video_val_loader,"name":"faceswapVideo"}
            for loader_info in [
                                {"loader": val_data_loader, "name": "KoDF"},
            ...
            # break
                ...
                with torch.no_grad():
                    ...
                    if writer is not None:
                        ...
                        writer.add_scalar(f"{loader_name}/Val/AUC", auc_val, epoch)
